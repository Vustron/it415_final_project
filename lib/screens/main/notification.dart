...
class _NotificationScreenState extends State<NotificationScreen> {
  List<NotificationUsers> notificationUsers = <NotificationUsers>[
    ...
    NotificationUsers(
        name: 'BabyCare',
        messageText: 'Theres a babysitter nearby with a 4.5-star rating, offering her services for only 350 pesos per day. Dont miss out—book her now!',
        imageURL: 'assets/images/placeholder_logo.png',
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return NotificationList(
                    ...
                    showButtons: notificationUsers[index].showButtons, // Controlled by you
                  );
                },
              ),
            ),
